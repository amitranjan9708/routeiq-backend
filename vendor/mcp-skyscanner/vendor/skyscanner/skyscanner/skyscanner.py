    ...
    def get_flight_prices(
        ...
        if req.status_code == 403:
            try:
                ...
                body = {}
            url = body.get("redirect_to") or "https://www.skyscanner.net/"
            msg = (
                "Skyscanner CAPTCHA block — try again later, VPN, or SKYSCANNER_PROXY"
                if body.get("action") == "captcha"
                else "Skyscanner access denied (403)"
            )
            raise BannedWithCaptcha(url, msg)
